...
const rawHandler = async (event) => {
    ...
    const { id, type } = jwt_1.verifyToken(oldRefreshToken);
    if (type !== auth_1.TOKEN_TYPE.REFRESH_TOKEN) {
        throw boom_1.badData('invalid token type');
    }
...
exports.handler = middy_1.default(rawHandler)
    ...
    .use(validator_1.validator(schema_1.refreshTokenSchema))
