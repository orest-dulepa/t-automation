...
const TermsOfUse: React.FC = () => (
  <>
    ...
    <InfoPage title="TERMS OF USE" subtitle="Last updated __________">
      <h2>AGREEMENT TO TERMS</h2>

      <p>
        These Terms of Use constitute a legally binding agreement made between you, whether
        personally or on behalf of an entity (“you”) and TA Inc (<b>“Company“</b>
        ...
        by accessing the Site, you have read, understood, and agreed to be bound by all of these
      ...
      <p>
        ...
        or unauthorized purpose; and (5) your use of the Site will not violate any applicable law or
        regulation.
      </p>
      ...
      <p>
        These Terms shall be governed by and defined following the laws of __________. T
        A Inc and yourself irrevocably consent that the courts of __________ shall have
      ...
      <p>
        ...
        arbitrators shall be __________. The seat, or legal place, of arbitration shall be
        __________. The language of the proceedings shall be __________. The governing law of the
        contract shall be the substantive law of __________.
      </p>
